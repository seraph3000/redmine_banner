...
* Fix: global banner could not be saved when edited from a project page as an admin (routing error to `/global_banner/<project>`). Now the global banner always posts correctly to `global_banner#update`.
